"""Test Qdrant implementation using offline model cache."""
...
def test_qdrant_retrieval():
    ...
    print("=" * 60)
    print("Testing Qdrant Vector Retrieval (Offline Mode)")
    print("=" * 60)
    ...
    # 2. Initialize embedding model (offline)
    print("\n[2/5] Loading embedding model from cache...")
